...
namespace QLTV
{
    public partial class frmTopMuonSach : DevExpress.XtraEditors.XtraForm
    {
        public frmTopMuonSach()
        {
            InitializeComponent();
        }
        ...
        private void btnXem_Click(object sender, EventArgs e)
        {
            ...
            new ReportPrintTool(new ReportTop10Sach(detNgayBatDau.DateTime, detNgayKetThuc.DateTime)).ShowPreviewDialog();
        }
